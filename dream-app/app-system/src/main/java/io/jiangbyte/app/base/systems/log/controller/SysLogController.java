package io.jiangbyte.app.base.systems.log.controller;
...
import io.jiangbyte.app.base.systems.log.service.SysLogService;
...
public class SysLogController {
    ...
    @Operation(summary = "获取系统活动日志记录Lists")
    @SaCheckPermission("/sys/log/lists")
    @GetMapping("/sys/log/lists")
    public Result<?> lists() {
        return Result.success(sysLogService.lists());
    }
