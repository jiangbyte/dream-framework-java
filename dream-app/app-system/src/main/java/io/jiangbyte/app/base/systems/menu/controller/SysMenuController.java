package io.jiangbyte.app.base.systems.menu.controller;
...
import io.jiangbyte.app.base.systems.menu.service.SysMenuService;
...
public class SysMenuController {
    ...
    @Operation(summary = "获取菜单Lists")
    @SaCheckPermission("/sys/menu/lists")
    @GetMapping("/sys/menu/lists")
    public Result<?> lists() {
        return Result.success(sysMenuService.lists());
    }
