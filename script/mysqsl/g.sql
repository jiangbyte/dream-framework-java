...
(
    ...
    `is_override`            TINYINT           DEFAULT 1 COMMENT '是否覆盖已有文件：1-是，0-否',
    `is_generate_controller` TINYINT           DEFAULT 0 COMMENT '是否生成Controller',
...
(
    ...
    `table_names`  JSON         NOT NULL COMMENT 'JSON 数组格式，如：["biz_normal_category", "biz_product_category"]',
