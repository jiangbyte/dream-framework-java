...
-- ----------------------------
INSERT INTO `auths_account` VALUES ('1', 'superadmin', '$2a$10$GO4/.3q0l/d/HWYaGKM2d.C4H.ZJmF4RhKVpFlC3sLuzFddlyucmK', 'jiangbyte@163.com', NULL, 0, 1, '2025-11-26 14:08:50', '2025-12-12 11:44:50', '127.0.0.1', 43, 0, NULL, NULL, '2025-11-25 09:22:21', NULL, '2025-12-12 11:44:50', NULL);
...
INSERT INTO `auths_role_menu` VALUES ('1999108630248153089', '1', '1999108629577064450');
INSERT INTO `auths_role_menu` VALUES ('1999324981482954754', '1', '1999324981029969921');
INSERT INTO `auths_role_menu` VALUES ('1999329168849575937', '1', '1999329168132349954');
...
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '代码生成任务主表' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `sys_code_task_module`  (
  ...
  `updated_by` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '最后更新人（账号/ID）',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '代码生成任务模块明细表' ROW_FORMAT = DYNAMIC;
...
-- Records of sys_menu
-- ----------------------------
INSERT INTO `sys_menu` VALUES ('1', '0', 'dashboard', '/dashboard', '/dashboard/index.vue', NULL, NULL, 0, 0, NULL, '仪表盘', 'dashboard', 1, 1, 1, 0, 0, NULL, NULL, 0, NULL, NULL, '2025-11-19 02:41:47', NULL, '2025-12-12 12:07:41', NULL);
...
INSERT INTO `sys_menu` VALUES ('1999108629577064450', '0', '123', '123', '123', NULL, NULL, 0, 0, NULL, '123', 'airplay-wave', 1, 1, 1, 1, 1, NULL, NULL, 1, NULL, NULL, '2025-12-11 21:26:54', NULL, '2025-12-11 21:27:18', NULL);
INSERT INTO `sys_menu` VALUES ('1999324981029969921', '0', NULL, NULL, NULL, NULL, NULL, 0, 0, NULL, NULL, NULL, 99, 0, 1, 0, 0, NULL, NULL, 1, NULL, NULL, '2025-12-12 11:46:36', NULL, '2025-12-12 11:46:41', NULL);
INSERT INTO `sys_menu` VALUES ('1999329168132349954', '0', '123', '123', NULL, NULL, NULL, 0, 0, NULL, '123', NULL, 99, 0, 1, 0, 0, NULL, NULL, 1, NULL, NULL, '2025-12-12 12:03:14', NULL, '2025-12-12 12:03:19', NULL);
...
INSERT INTO `sys_menu` VALUES ('25', '24', '404', '/code/404', '/code/404.vue', NULL, NULL, 0, 0, NULL, '404页面', 'battery', 1, 0, 1, 0, 0, NULL, NULL, 0, NULL, NULL, '2025-11-19 02:41:47', NULL, '2025-12-12 12:03:52', NULL);
