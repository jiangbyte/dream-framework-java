...
import { useAuthsAccountGroupApi } from '@/api'
...
async function doSubmit() {
  ...
  if (validateResult === true) {
    const api = isEdit.value
      ? useAuthsAccountGroupApi().EditAuthsAccountGroup
      : useAuthsAccountGroupApi().AddAuthsAccountGroup
  ...
  >
    ...
    >
      ...
      >
        ...
        <t-form-item label="角色ID" name="groupId">
          <t-input v-model="formData.groupId" placeholder="请输入角色ID" />
        </t-form-item>
      </t-form>
    </t-loading>
  </t-drawer>
