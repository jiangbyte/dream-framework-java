...
export const FORM_RULES = {
    ...
    language: [{ required: true, message: '请输入系统语言' }],
    emailNotifications: [{ required: true, message: '请输入邮件通知' }],
    pushNotifications: [{ required: true, message: '请输入推送通知' }],
    allowDirectMessage: [{ required: true, message: '请输入允许私信' }],
}